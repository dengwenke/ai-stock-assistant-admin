...
- 人机协作入口：`AGENTS.md`
- 知识库入口：`docs/knowledge-base/INDEX.md`
- 管理端设计规范：`docs/knowledge-base/design/DESIGN_SYSTEM.md`
- 管理端目录结构规范：`docs/knowledge-base/standards/PROJECT_STRUCTURE.md`
...
| Outbox 事件 | `/outbox`         | `GET /api/admin/outbox/events`、`POST /api/admin/outbox/events/*` |
...
- 本仓库是管理端前端；后端 Java 代码规范请查看后端仓库 `ai-stock-assistant` 的相关文档。
